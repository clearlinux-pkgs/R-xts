...
Version  : 0.12.0
Release  : 41
URL      : https://cran.r-project.org/src/contrib/xts_0.12-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xts_0.12-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579630364
...
/usr/lib64/R/library/xts/benchmarks/benchmark.binsearch.R
/usr/lib64/R/library/xts/benchmarks/benchmark.eval.dots.R
