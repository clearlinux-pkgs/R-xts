...
Version  : 0.14.1
Release  : 74
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/xts_0.14.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/xts_0.14.1.tar.gz
...
%package dev
Summary: dev components for the R-xts package.
Group: Development
Requires: R-xts-lib = %{version}-%{release}
Provides: R-xts-devel = %{version}-%{release}
Requires: R-xts = %{version}-%{release}

%description dev
dev components for the R-xts package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731653067
