...
Version  : 0.13.1
Release  : 67
URL      : https://cran.r-project.org/src/contrib/xts_0.13.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xts_0.13.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681752557
...
/usr/lib64/R/library/xts/tinytest/test-long-vector-support.R
